...
# 唤醒词配置
WAKE_WORD_PATH = os.path.join(BASE_DIR, "models", "小德_zh_mac_v4_0_0.ppn")
PORCUPINE_MODEL_PATH = os.path.join(BASE_DIR, "models", "porcupine_params_zh.pv")
EMOTION_MODEL_PATH = os.path.join(BASE_DIR, "models", "emotion.onnx")
...
MASTER_FACE_EMBEDDING_PATH = os.path.join(BASE_DIR, "models", "master_face.npy")
