...
class FletUI:
    ...
    def main(self, page: ft.Page):
        ...
        self.status_text = ft.Text("空闲中", size=20, weight=ft.FontWeight.BOLD)
        
        # 实时识别文本
        self.transcription_text = ft.Text("", size=16, color=ft.colors.GREY_400, italic=True)
        
        # AI 回复文本
        self.response_text = ft.Text("", size=18, color=ft.colors.WHITE)
            ...
            ft.Container(
                content=ft.Column(
                    [
                        ...
                        ft.Column([
                            ft.Text("你:", size=14, color=ft.colors.GREY_500),
                            self.transcription_text,
                        ]),
                        ft.Divider(height=10, color=ft.colors.TRANSPARENT),
                        ft.Column([
                            ft.Text("小德:", size=14, color=ft.colors.GREY_500),
                            self.response_text,
                        ]),
                    ],
